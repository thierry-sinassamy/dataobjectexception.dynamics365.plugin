...
namespace Dataobjectexception.Plugins.Models
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Microsoft.Xrm.Sdk.OptionSetValue AccountCategoryCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("accountcategorycode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue AccountClassificationCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("accountclassificationcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue AccountRatingCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("accountratingcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue Address1_AddressTypeCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("address1_addresstypecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue Address1_FreightTermsCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("address1_freighttermscode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue Address1_ShippingMethodCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("address1_shippingmethodcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue Address2_AddressTypeCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("address2_addresstypecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue Address2_FreightTermsCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("address2_freighttermscode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue Address2_ShippingMethodCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("address2_shippingmethodcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue BusinessTypeCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("businesstypecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue CustomerSizeCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("customersizecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue CustomerTypeCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("customertypecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		/// <summary>
		/// Type the fax number for the account. No spaces or other characters are allowed (Ex. 5141234567).
		/// </summary>
		...
		public Microsoft.Xrm.Sdk.OptionSetValue IndustryCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("industrycode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_autrebannire")]
		public System.Nullable<bool> new_AutreBannire
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_autrebannire");
			}
			set
			{
				this.OnPropertyChanging("new_AutreBannire");
				this.SetAttributeValue("new_autrebannire", value);
				this.OnPropertyChanged("new_AutreBannire");
			}
		}
		
		/// <summary>
		/// Utilisation du B2B pour le download des catalogues / Use B2B for catalogue donwload
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_b2b_catalogue_module")]
		public System.Nullable<bool> new_B2B_Catalogue_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_b2b_catalogue_module");
			}
			set
			{
				this.OnPropertyChanging("new_B2B_Catalogue_module");
				this.SetAttributeValue("new_b2b_catalogue_module", value);
				this.OnPropertyChanged("new_B2B_Catalogue_module");
			}
		}
		
		/// <summary>
		/// Utilisation de la commande fournisseur Vision Web B2B / Use B2B ordering on line vision Web
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_b2b_cmds_en_ligne_module")]
		public System.Nullable<bool> new_B2B_Cmds_en_ligne_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_b2b_cmds_en_ligne_module");
			}
			set
			{
				this.OnPropertyChanging("new_B2B_Cmds_en_ligne_module");
				this.SetAttributeValue("new_b2b_cmds_en_ligne_module", value);
				this.OnPropertyChanged("new_B2B_Cmds_en_ligne_module");
			}
		}
		
		/// <summary>
		/// List of clinics linked to the server
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_cliniclierauserveur")]
		public string new_Cliniclierauserveur
		{
			get
			{
				return this.GetAttributeValue<string>("new_cliniclierauserveur");
			}
			set
			{
				this.OnPropertyChanging("new_Cliniclierauserveur");
				this.SetAttributeValue("new_cliniclierauserveur", value);
				this.OnPropertyChanged("new_Cliniclierauserveur");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_communication_module")]
		public System.Nullable<bool> new_Communication_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_communication_module");
			}
			set
			{
				this.OnPropertyChanging("new_Communication_module");
				this.SetAttributeValue("new_communication_module", value);
				this.OnPropertyChanged("new_Communication_module");
			}
		}
		
		/// <summary>
		/// Utilisation de l'automatisme pour le champs visuel dans pièces jointes / automatic link to attachements with visual field
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_equipautomatique_visualfield")]
		public System.Nullable<bool> new_Equipautomatique_visualfield
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_equipautomatique_visualfield");
			}
			set
			{
				this.OnPropertyChanging("new_Equipautomatique_visualfield");
				this.SetAttributeValue("new_equipautomatique_visualfield", value);
				this.OnPropertyChanged("new_Equipautomatique_visualfield");
			}
		}
		
		/// <summary>
		/// Lien avec équipements Ophtalmique via module Examen / Link with Ophthalmic equipment with exam module
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_equipementopht_module")]
		public System.Nullable<bool> new_EquipementOpht_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_equipementopht_module");
			}
			set
			{
				this.OnPropertyChanging("new_EquipementOpht_module");
				this.SetAttributeValue("new_equipementopht_module", value);
				this.OnPropertyChanged("new_EquipementOpht_module");
			}
		}
		
		/// <summary>
		/// Utilisation du module de gestion KPI / Use Admin KPI module
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_gestionkpi_modue")]
		public System.Nullable<bool> new_GestionKPI_modue
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_gestionkpi_modue");
			}
			set
			{
				this.OnPropertyChanging("new_GestionKPI_modue");
				this.SetAttributeValue("new_gestionkpi_modue", value);
				this.OnPropertyChanged("new_GestionKPI_modue");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_huvitz_clm3100p")]
		public System.Nullable<bool> new_Huvitz_CLM3100P
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_huvitz_clm3100p");
			}
			set
			{
				this.OnPropertyChanging("new_Huvitz_CLM3100P");
				this.SetAttributeValue("new_huvitz_clm3100p", value);
				this.OnPropertyChanged("new_Huvitz_CLM3100P");
			}
		}
		
		/// <summary>
		/// Indiquez le nom légal de l’entreprise / Enter company's legal name
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_legalname")]
		public string new_legalname
		{
			get
			{
				return this.GetAttributeValue<string>("new_legalname");
			}
			set
			{
				this.OnPropertyChanging("new_legalname");
				this.SetAttributeValue("new_legalname", value);
				this.OnPropertyChanged("new_legalname");
			}
		}
		
		/// <summary>
		/// Indiquer l’appareil qui est directement lié aux pièces jointes d’Optosys /  tag the equipment with auto attach to attachement tab in Optosys
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_liste_equiepements_automatique")]
		public Microsoft.Xrm.Sdk.OptionSetValue new_Liste_equiepements_automatique
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("new_liste_equiepements_automatique");
			}
			set
			{
				this.OnPropertyChanging("new_Liste_equiepements_automatique");
				this.SetAttributeValue("new_liste_equiepements_automatique", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
				this.OnPropertyChanged("new_Liste_equiepements_automatique");
			}
		}
		
		/// <summary>
		/// Utilisation du module examen/Use exam module
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_module_examen")]
		public System.Nullable<bool> new_module_examen
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_module_examen");
			}
			set
			{
				this.OnPropertyChanging("new_module_examen");
				this.SetAttributeValue("new_module_examen", value);
				this.OnPropertyChanged("new_module_examen");
			}
		}
		
		/// <summary>
		/// Indique le nombre de poste de la clinique avec Optosys (nombre de licences) / Number of computers with O2
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_nombredeposte")]
		public string new_nombredeposte
		{
			get
			{
				return this.GetAttributeValue<string>("new_nombredeposte");
			}
			set
			{
				this.OnPropertyChanging("new_nombredeposte");
				this.SetAttributeValue("new_nombredeposte", value);
				this.OnPropertyChanged("new_nombredeposte");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_projectmanager")]
		public Microsoft.Xrm.Sdk.EntityReference new_ProjectManager
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("new_projectmanager");
			}
			set
			{
				this.OnPropertyChanging("new_ProjectManager");
				this.SetAttributeValue("new_projectmanager", value);
				this.OnPropertyChanged("new_ProjectManager");
			}
		}
		...
		public string new_ProjectName
		{
			...
			set
			{
				this.OnPropertyChanging("new_ProjectName");
				this.SetAttributeValue("new_projectname", value);
				this.OnPropertyChanged("new_ProjectName");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_reichert_rk600")]
		public System.Nullable<bool> new_Reichert_RK600
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_reichert_rk600");
			}
			set
			{
				this.OnPropertyChanging("new_Reichert_RK600");
				this.SetAttributeValue("new_reichert_rk600", value);
				this.OnPropertyChanged("new_Reichert_RK600");
			}
		}
		...
		/// Clinic remote
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_remote")]
		public System.Nullable<bool> new_Remote
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_remote");
			}
			set
			{
				this.OnPropertyChanging("new_Remote");
				this.SetAttributeValue("new_remote", value);
				this.OnPropertyChanged("new_Remote");
			}
		}
		
		/// <summary>
		/// Utilisation de l'agenda en ligne /  Use Online booking module
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_rendezvousweb_module")]
		public System.Nullable<bool> new_Rendezvousweb_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_rendezvousweb_module");
			}
			set
			{
				this.OnPropertyChanging("new_Rendezvousweb_module");
				this.SetAttributeValue("new_rendezvousweb_module", value);
				this.OnPropertyChanged("new_Rendezvousweb_module");
			}
		}
		
		/// <summary>
		/// Define the setup of the clinic with Optosys
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_server_connection")]
		public Microsoft.Xrm.Sdk.OptionSetValue new_Server_connection
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("new_server_connection");
			}
			set
			{
				this.OnPropertyChanging("new_Server_connection");
				this.SetAttributeValue("new_server_connection", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
				this.OnPropertyChanged("new_Server_connection");
			}
		}
		...
		/// Multi clinic server
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_servermulticlinic")]
		public System.Nullable<bool> new_ServerMulticlinic
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_servermulticlinic");
			}
			set
			{
				this.OnPropertyChanging("new_ServerMulticlinic");
				this.SetAttributeValue("new_servermulticlinic", value);
				this.OnPropertyChanged("new_ServerMulticlinic");
			}
		}
		
		/// <summary>
		/// Utiliation du module service backup en ligne / use the service of online backup
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_servicebackupenligne_module")]
		public System.Nullable<bool> new_servicebackupenligne_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_servicebackupenligne_module");
			}
			set
			{
				this.OnPropertyChanging("new_servicebackupenligne_module");
				this.SetAttributeValue("new_servicebackupenligne_module", value);
				this.OnPropertyChanged("new_servicebackupenligne_module");
			}
		}
		
		/// <summary>
		/// Utilisation du module taches / Use task module
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_taches_module")]
		public System.Nullable<bool> new_Taches_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_taches_module");
			}
			set
			{
				this.OnPropertyChanging("new_Taches_module");
				this.SetAttributeValue("new_taches_module", value);
				this.OnPropertyChanged("new_Taches_module");
			}
		}
		
		/// <summary>
		/// Utilisation du module TELUS / Use telus module
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_telus_module")]
		public System.Nullable<bool> new_Telus_module
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_telus_module");
			}
			set
			{
				this.OnPropertyChanging("new_Telus_module");
				this.SetAttributeValue("new_telus_module", value);
				this.OnPropertyChanged("new_Telus_module");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_topcon_kr8000")]
		public System.Nullable<bool> new_Topcon_KR8000
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_topcon_kr8000");
			}
			set
			{
				this.OnPropertyChanging("new_Topcon_KR8000");
				this.SetAttributeValue("new_topcon_kr8000", value);
				this.OnPropertyChanged("new_Topcon_KR8000");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_topcon_trk1p")]
		public System.Nullable<bool> new_Topcon_TRK1P
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_topcon_trk1p");
			}
			set
			{
				this.OnPropertyChanging("new_Topcon_TRK1P");
				this.SetAttributeValue("new_topcon_trk1p", value);
				this.OnPropertyChanged("new_Topcon_TRK1P");
			}
		}
		...
		/// <summary>
		/// Activation du backup en ligne avec CDT
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_cdt_backupsolution")]
		public System.Nullable<bool> opto_CDT_Backupsolution
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("opto_cdt_backupsolution");
			}
			set
			{
				this.OnPropertyChanging("opto_CDT_Backupsolution");
				this.SetAttributeValue("opto_cdt_backupsolution", value);
				this.OnPropertyChanged("opto_CDT_Backupsolution");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_commpatient")]
		public System.Nullable<bool> opto_CommPatient
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("opto_commpatient");
			}
			set
			{
				this.OnPropertyChanging("opto_CommPatient");
				this.SetAttributeValue("opto_commpatient", value);
				this.OnPropertyChanged("opto_CommPatient");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_multiserver")]
		public System.Nullable<bool> opto_MultiServer
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("opto_multiserver");
			}
			set
			{
				this.OnPropertyChanging("opto_MultiServer");
				this.SetAttributeValue("opto_multiserver", value);
				this.OnPropertyChanged("opto_MultiServer");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_multiwith")]
		public string opto_MultiWith
		{
			get
			{
				return this.GetAttributeValue<string>("opto_multiwith");
			}
			set
			{
				this.OnPropertyChanging("opto_MultiWith");
				this.SetAttributeValue("opto_multiwith", value);
				this.OnPropertyChanged("opto_MultiWith");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_optosyscontractenddate")]
		public System.Nullable<System.DateTime> opto_OptosysContractEndDate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("opto_optosyscontractenddate");
			}
			set
			{
				this.OnPropertyChanging("opto_OptosysContractEndDate");
				this.SetAttributeValue("opto_optosyscontractenddate", value);
				this.OnPropertyChanged("opto_OptosysContractEndDate");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_optosysinstalleddate")]
		public System.Nullable<System.DateTime> opto_OptosysInstalledDate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("opto_optosysinstalleddate");
			}
			set
			{
				this.OnPropertyChanging("opto_OptosysInstalledDate");
				this.SetAttributeValue("opto_optosysinstalleddate", value);
				this.OnPropertyChanged("opto_OptosysInstalledDate");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_remote")]
		public System.Nullable<bool> opto_Remote
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("opto_remote");
			}
			set
			{
				this.OnPropertyChanging("opto_Remote");
				this.SetAttributeValue("opto_remote", value);
				this.OnPropertyChanged("opto_Remote");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_server")]
		public System.Nullable<bool> opto_Server
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("opto_server");
			}
			set
			{
				this.OnPropertyChanging("opto_Server");
				this.SetAttributeValue("opto_server", value);
				this.OnPropertyChanged("opto_Server");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_versioncouranteoptosys")]
		public string opto_VersioncouranteOptosys
		{
			get
			{
				return this.GetAttributeValue<string>("opto_versioncouranteoptosys");
			}
			set
			{
				this.OnPropertyChanging("opto_VersioncouranteOptosys");
				this.SetAttributeValue("opto_versioncouranteoptosys", value);
				this.OnPropertyChanged("opto_VersioncouranteOptosys");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("opto_versioncouranteportail")]
		public string opto_VersioncourantePortail
		{
			get
			{
				return this.GetAttributeValue<string>("opto_versioncouranteportail");
			}
			set
			{
				this.OnPropertyChanging("opto_VersioncourantePortail");
				this.SetAttributeValue("opto_versioncouranteportail", value);
				this.OnPropertyChanged("opto_VersioncourantePortail");
			}
		}
		...
		public Microsoft.Xrm.Sdk.OptionSetValue OwnershipCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("ownershipcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue PaymentTermsCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("paymenttermscode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue PreferredAppointmentDayCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("preferredappointmentdaycode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue PreferredAppointmentTimeCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("preferredappointmenttimecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue PreferredContactMethodCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("preferredcontactmethodcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public Microsoft.Xrm.Sdk.OptionSetValue ShippingMethodCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("shippingmethodcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public System.Nullable<Dataobjectexception.Plugins.Models.AccountState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Dataobjectexception.Plugins.Models.AccountState)(System.Enum.ToObject(typeof(Dataobjectexception.Plugins.Models.AccountState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Microsoft.Xrm.Sdk.OptionSetValue StatusCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("statuscode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		/// <summary>
		/// Type the main phone number for this account. No spaces or other characters are allowed (Ex. 5141234567).
		/// </summary>
		...
		public Microsoft.Xrm.Sdk.OptionSetValue TerritoryCode
		{
			...
			set
			{
				...
				this.SetAttributeValue("territorycode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
		...
		public System.Collections.Generic.IEnumerable<Dataobjectexception.Plugins.Models.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<Dataobjectexception.Plugins.Models.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_master_account");
				this.SetRelatedEntities<Dataobjectexception.Plugins.Models.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Dataobjectexception.Plugins.Models.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<Dataobjectexception.Plugins.Models.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_parent_account");
				this.SetRelatedEntities<Dataobjectexception.Plugins.Models.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public Dataobjectexception.Plugins.Models.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<Dataobjectexception.Plugins.Models.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public Dataobjectexception.Plugins.Models.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<Dataobjectexception.Plugins.Models.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingaccount_parent_account");
				this.SetRelatedEntity<Dataobjectexception.Plugins.Models.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "8.2.1.8676")]
    public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging,
        System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue AccountRoleCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("accountrolecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue Address1_ShippingMethodCode
        {
            ...
            {
                this.OnPropertyChanging("Address1_ShippingMethodCode");
                this.SetAttributeValue("address1_shippingmethodcode",
                    new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
                this.OnPropertyChanged("Address1_ShippingMethodCode");
            }
        }
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue Address2_ShippingMethodCode
        {
            ...
            {
                this.OnPropertyChanging("Address2_ShippingMethodCode");
                this.SetAttributeValue("address2_shippingmethodcode",
                    new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
                this.OnPropertyChanged("Address2_ShippingMethodCode");
            }
        }
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue Address3_AddressTypeCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("address3_addresstypecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue Address3_FreightTermsCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("address3_freighttermscode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue Address3_ShippingMethodCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("address3_shippingmethodcode",
                    new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue EducationCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("educationcode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue FamilyStatusCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("familystatuscode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue GenderCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("gendercode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue HasChildrenCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("haschildrencode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue LeadSourceCode
        {
            ...
            set
            {
                ...
                this.SetAttributeValue("leadsourcecode", new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
        ...
        /// 
        /// </summary>
        [Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_fusionner")]
        public System.Nullable<bool> new_fusionner
        {
            get { return this.GetAttributeValue<System.Nullable<bool>>("new_fusionner"); }
            set
            {
                this.OnPropertyChanging("new_fusionner");
                this.SetAttributeValue("new_fusionner", value);
                this.OnPropertyChanged("new_fusionner");
            }
        }
        ...
        /// 
        /// </summary>
        [Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_marketinglist")]
        public System.Nullable<bool> new_MarketingList
        {
            get { return this.GetAttributeValue<System.Nullable<bool>>("new_marketinglist"); }
            set
            {
                this.OnPropertyChanging("new_MarketingList");
                this.SetAttributeValue("new_marketinglist", value);
                this.OnPropertyChanged("new_MarketingList");
            }
        }

        /// <summary>
        /// Entrer une description du rôle de l'utilisateur/Enter the user role for Optosys
        /// </summary>
        [Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_roleoptosys")]
        public string new_RoleOptosys
        {
            get { return this.GetAttributeValue<string>("new_roleoptosys"); }
            set
            {
                this.OnPropertyChanging("new_RoleOptosys");
                this.SetAttributeValue("new_roleoptosys", value);
                this.OnPropertyChanged("new_RoleOptosys");
            }
        }
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue PreferredAppointmentDayCode
        {
            ...
            {
                this.OnPropertyChanging("PreferredAppointmentDayCode");
                this.SetAttributeValue("preferredappointmentdaycode",
                    new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
                this.OnPropertyChanged("PreferredAppointmentDayCode");
            }
        }
        ...
        public Microsoft.Xrm.Sdk.OptionSetValue PreferredAppointmentTimeCode
        {
            ...
            {
                this.OnPropertyChanging("PreferredAppointmentTimeCode");
                this.SetAttributeValue("preferredappointmenttimecode",
                    new Microsoft.Xrm.Sdk.OptionSetValue(value.Value));
                this.OnPropertyChanged("PreferredAppointmentTimeCode");
            }
        }
        ...
        public System.Collections.Generic.IEnumerable<Dataobjectexception.Plugins.Models.Account>
            account_primary_contact
        {
            get
            {
                return this.GetRelatedEntities<Dataobjectexception.Plugins.Models.Account>("account_primary_contact",
                    null);
            }
            set
            {
                this.OnPropertyChanging("account_primary_contact");
                this.SetRelatedEntities<Dataobjectexception.Plugins.Models.Account>("account_primary_contact", null,
                    value);
        ...
        public Dataobjectexception.Plugins.Models.Account contact_customer_accounts
        {
            get
            {
                return this.GetRelatedEntity<Dataobjectexception.Plugins.Models.Account>("contact_customer_accounts",
                    null);
            }
            set
            {
                this.OnPropertyChanging("contact_customer_accounts");
                this.SetRelatedEntity<Dataobjectexception.Plugins.Models.Account>("contact_customer_accounts", null,
                    value);
