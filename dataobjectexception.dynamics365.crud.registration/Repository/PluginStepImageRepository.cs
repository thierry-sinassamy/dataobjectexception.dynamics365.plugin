...
namespace dataobjectexception.dynamics365.crud.registration.Repository
{
    public class PluginStepImageRepository : Repository<Entities.SdkMessageProcessingStepImage>
    {
        ...
        public override OrganizationResponse UpdateWithRequest(Entities.SdkMessageProcessingStepImage entity)
        {
            var request = new UpdateRequest { Target = entity };
            return Datacontext.DataContextEntities.Execute(request);
        }

        public override OrganizationResponse DeleteWithRequest(Entities.SdkMessageProcessingStepImage entity)
        {
